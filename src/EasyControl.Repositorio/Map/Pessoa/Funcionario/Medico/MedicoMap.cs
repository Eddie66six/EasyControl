...
{
    public class MedicoMap : IEntityTypeConfiguration<Dominio.Pessoa.Funcionario.Medico.Entidade.Medico>
    {
        public void Configure(EntityTypeBuilder<Dominio.Pessoa.Funcionario.Medico.Entidade.Medico> builder)
        {
